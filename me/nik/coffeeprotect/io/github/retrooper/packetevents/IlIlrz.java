...
import me.nik.coffeeprotect.io.github.retrooper.packetevents.IlIlWg;

public class IlIlrz
extends ChannelInboundHandlerAdapter {
    private static final InternalLogger IlIlb;
    ...
    public void channelRegistered(ChannelHandlerContext channelHandlerContext) {
        block17: {
            ...
            block16: {
                ...
                nArray = IlIlWg.IlIlR();
                IlIlWg.IlIlq(channelHandlerContext.channel(), IlIlrk.HANDSHAKING);
                ...
                block18: {
                            ...
                            block19: {
                                ...
                                try {
                                    try {
                                        ...
                                        throw IlIlrz.a(throwable3);
                                    }
                                    channelPipeline4 = channelPipeline5;
                                    ilIlrz3 = this;
                                }
                                catch (Throwable throwable4) {
                                    throw IlIlrz.a(throwable4);
                                }
                            }
                    ...
                    try {
                        try {
                            ...
                            throw IlIlrz.a(throwable5);
                        }
                        channelPipeline3 = channelPipeline6;
                        ilIlrz2 = this;
                    }
                    catch (Throwable throwable6) {
                        throw IlIlrz.a(throwable6);
                    }
                }
    ...
    public void exceptionCaught(ChannelHandlerContext channelHandlerContext, Throwable throwable) {
        ...
        IlIlb.warn(b + channelHandlerContext.channel(), throwable);
     ...
     */
    static {
        a = IlIls.a(7972213813962596676L, 8522512304716872861L, MethodHandles.lookup().lookupClass()).a(20536452484338L);
        ...
        while (true) {
            if (n >= 8) {
                ...
                b = IlIlrz.a(byArray3).intern();
                IlIlb = InternalLoggerFactory.getInstance(ChannelInitializer.class);
                return;
            }
            byArray2 = byArray2;
