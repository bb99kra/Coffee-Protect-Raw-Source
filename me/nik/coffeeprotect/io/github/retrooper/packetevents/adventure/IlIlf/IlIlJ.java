 ...
 */
package me.nik.coffeeprotect.io.github.retrooper.packetevents.adventure.IlIlf;
...
import me.nik.coffeeprotect.io.github.retrooper.packetevents.adventure.IlIlTJ;
import me.nik.coffeeprotect.io.github.retrooper.packetevents.adventure.IlIljU;
import me.nik.coffeeprotect.io.github.retrooper.packetevents.adventure.IlIlnx;
...
Services.Fallback {
    ...
    @Override
    @NotNull
    public @NotNull Supplier<@NotNull IlIlTJ> IlIlf() {
        return IlIloV::IlIlQ;
    }
    ...
    public static void IlIlT(String[] stringArray) {
        IlIlP = stringArray;
    }
     ...
     */
    static {
        a = IlIls.a(-7741023641863354319L, -8033372539790993595L, MethodHandles.lookup().lookupClass()).a(280615706826780L);
        long l = a ^ 0x5249EBD4083FL;
        IlIlJ.IlIlT(new String[2]);
