...
final class IlIlAr
extends TypeAdapter<IlIlX5> {
    static final TypeAdapter<IlIlX5> IlIlo;
    static final TypeAdapter<IlIlX5> IlIlW;
    private final boolean IlIly;
    private static final long a;
    private static final String b;
    private static final long c;
    private static transient /* synthetic */ String ntUqWbqzvJ = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";

    private IlIlAr(boolean bl) {
        this.IlIly = bl;
    }

    public void IlIla(JsonWriter jsonWriter, IlIlX5 ilIlX5) throws IOException {
        block12: {
            boolean bl;
            String[] stringArray;
            block10: {
                long l = a ^ 0x725579084481L;
                stringArray = IlIlGB.IlIlC();
                try {
                    block11: {
                        try {
                            try {
                                bl = ilIlX5 instanceof IlIlxu;
                                if (stringArray == null) break block10;
                                if (!bl) break block11;
                            }
                            catch (IOException iOException) {
                                throw IlIlAr.a(iOException);
                            }
                            jsonWriter.value(IlIlxu.IlIlq.key((IlIlxu)ilIlX5));
            ...
            try {
                block13: {
                    try {
                        if (!bl) break block13;
                        jsonWriter.value(IlIlxu.IlIlq.key(IlIlxu.IlIlX(ilIlX5)));
                        if (stringArray != null) break block12;
                    }
                    catch (IOException iOException) {
                        throw IlIlAr.a(iOException);
                ...
                jsonWriter.value(IlIlAr.IlIlY(ilIlX5));
            }
            catch (IOException iOException) {
                throw IlIlAr.a(iOException);
            }
    ...
    private static String IlIlY(IlIlX5 ilIlX5) {
        long l = a ^ 0x654B6101382BL;
        return String.format(Locale.ROOT, b, Character.valueOf((char)c), ilIlX5.IlIle());
    }

    @Nullable
    public IlIlX5 IlIly(JsonReader jsonReader) throws IOException {
        IlIlX5 ilIlX5;
        long l = a ^ 0x33D6DF1C1D31L;
        IlIlX5 ilIlX52 = IlIlAr.IlIlF(jsonReader.nextString());
        try {
            if (ilIlX52 == null) {
                return null;
            }
        ...
        try {
            ilIlX5 = this.IlIly ? IlIlxu.IlIlX(ilIlX52) : ilIlX52;
        }
        catch (IOException iOException) {
            throw IlIlAr.a(iOException);
        }
    ...
    @Nullable
    static IlIlX5 IlIlF(@NotNull String string) {
        long l = a ^ 0x4AB63EBDB979L;
        String[] stringArray = IlIlGB.IlIlC();
        Object object = string;
        if (stringArray != null) {
            if (((String)object).startsWith("#")) {
                return IlIlX5.IlIlN(string);
            }
            object = IlIlxu.IlIlq.value(string);
        }
        return (IlIlX5)object;
    }
     ...
     */
    static {
        a = IlIls.a(-623516435521430455L, -6519443547651597339L, MethodHandles.lookup().lookupClass()).a(97288995097112L);
        ...
        while (true) {
            if (n >= 8) {
                ...
                IlIlo = new IlIlAr(false).nullSafe();
                IlIlW = new IlIlAr(true).nullSafe();
                return;
            }
            byArray5 = byArray5;
