...
public class IlIlim
extends IlIlis {
    private final Callable<String> IlIlP;
    private static final long a = IlIls.a(4672464929565793500L, 2671025911104995892L, MethodHandles.lookup().lookupClass()).a(122777307572313L);
    private static final String f;
    private static transient /* synthetic */ String wfrpCfqhYq = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";

    public IlIlim(String string, Callable<String> callable) {
        super(string);
        this.IlIlP = callable;
    }
    ...
    protected IlIlOI IlIlS() throws Exception {
        ...
        block4: {
            ...
            try {
                ...
                throw IlIlim.a(exception);
            }
            string = string2;
        }
        try {
            if (!string.isEmpty()) return new IlIlZb().IlIlp(f, string2).IlIld();
            return null;
        }
        catch (Exception exception) {
            throw IlIlim.a(exception);
