...
public class IlIli_
extends IlIlis {
    private final Callable<Integer> IlIlP;
    private static final long a = IlIls.a(-5019132653378871002L, -8309940818728691331L, MethodHandles.lookup().lookupClass()).a(184037748227863L);
    private static final String f;
    private static transient /* synthetic */ String ZtMqwUQyNl = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";

    public IlIli_(String string, Callable<Integer> callable) {
        super(string);
        this.IlIlP = callable;
    }
    ...
    protected IlIlOI IlIlS() throws Exception {
        ...
        try {
            ...
            throw IlIli_.a(exception);
        }
        return new IlIlZb().IlIlQ(f, n).IlIld();
    }
