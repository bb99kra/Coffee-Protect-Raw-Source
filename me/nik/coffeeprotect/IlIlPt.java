...
implements IlIljR {
    ...
    public void IlIlq(Player player, IlIlWx ilIlWx) {
        ...
        IlIlG2 ilIlG2 = IlIlr7.IlIlb().IlIlq().IlIlV(player);
        int n = IlIlPt.IlIlD();
        ...
        block0 : switch (IlIlCF.IlIlE[ilIlWx.ordinal()]) {
            case 1: {
                ...
                IlIlv_ ilIlv_ = new IlIlv_(f, f, f);
                IlIlD1 ilIlD1 = new IlIlD1(ilIlv_, ilIlv_);
                ilIlD1.IlIld(Collections.emptyList());
                ilIlD1.IlIlE(IlIlP.KEEP_BLOCKS);
                ilIlD1.IlIlM(new IlIlum<IlIlut>(IlIljn.IlIlhm));
                IlIlDI ilIlDI = new IlIlDI(new IlIlum<IlIlut>(IlIljn.IlIlhm), true, new IlIlv_(location.getX(), location.getY(), location.getZ()), new IlIlQG(f, f, f), f, (int)callSite);
    ...
    @Override
    public void IlIlC() {
        IlIlr7.IlIlb().IlIlg().IlIl_(this);
    }

    @Override
    public void IlIly() {
        this.IlIle.clear();
        IlIlr7.IlIlb().IlIlg().IlIlA(this);
    }
            ...
            block25: {
                block24: {
                    block23: {
                        block22: {
                            block21: {
                                IlIlPt.a = IlIls.a(7183996068580144861L, 1711922279806884736L, MethodHandles.lookup().lookupClass()).a(15844057377645L);
