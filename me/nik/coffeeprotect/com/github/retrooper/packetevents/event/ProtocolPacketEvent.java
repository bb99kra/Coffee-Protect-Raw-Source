...
import me.nik.coffeeprotect.com.github.retrooper.packetevents.IlIlGj;
...
import me.nik.coffeeprotect.com.github.retrooper.packetevents.event.IlIlT3;
import me.nik.coffeeprotect.com.github.retrooper.packetevents.event.IlIlhS;
import me.nik.coffeeprotect.com.github.retrooper.packetevents.event.IlIljE;
import me.nik.coffeeprotect.com.github.retrooper.packetevents.event.IlIlnQ;
...
IlIljE {
    ...
    private final IlIloL packetType;
    private ServerVersion serverVersion;
    private final Object channel;
    private final IlIlrk connectionState;
    private final IlIlG2 user;
     ...
     */
    public ProtocolPacketEvent(IlIlhC var1_1, Object var2_2, IlIlG2 var3_3, @UnknownNullability Object var4_4, Object var5_5, boolean var6_6) throws IlIljj {
        block27: {
            block28: {
                block29: {
                    block25: {
                        block26: {
                            block24: {
                                block23: {
                                    block22: {
                                        block30: {
                                            ...
                                            super();
                                            this.postTasks = null;
                                            this.needsReEncode = IlIlr7.IlIlb().IlIlV().IlIls();
                                            this.channel = var2_2;
                                            this.user = var3_3;
                                            var9_8 = IlIlnQ.IlIlJ();
                                            this.player = var4_4;
                                        ...
                                        try {
                                            block31: {
                                                if (var3_3.IlIlh() != null) break block23;
                                                break block31;
                                                catch (Exception v1) {
                                                    throw ProtocolPacketEvent.a(v1);
                                                }
                                            }
                                            this.serverVersion = IlIlr7.IlIlb().IlIlq().IlIlF();
                                        }
                                        catch (Exception v2) {
                                ...
                                this.serverVersion = var3_3.IlIlr().toServerVersion();
                            }
                            this.byteBuf = var5_5;
                            var10_9 = ByteBufHelper.IlIlH(var5_5);
                            ...
                            try {
                                ...
                                throw new IlIljj((String)ProtocolPacketEvent.a("w", (int)26730, (long)(4830620490741303421L ^ var7_7)));
                            }
                            catch (Exception v5) {
                        ...
                        try {
                            this.packetID = ByteBufHelper.IlIlb(var5_5);
                        }
                        catch (Exception var11_10) {
                            throw new IlIljj((String)ProtocolPacketEvent.a("w", (int)7078, (long)(3945493639196392368L ^ var7_7)) + var10_9 + ")");
                        }
                    }
                    var11_11 = this.serverVersion.IlIlE();
                    try {
                        v6 = this;
                        v7 = var1_1 == IlIlhC.CLIENT ? var3_3.IlIlT() : var3_3.IlIlb();
                    }
                    catch (Exception v8) {
                        throw ProtocolPacketEvent.a(v8);
                    }
                    v6.connectionState = v7;
                    var12_12 = IlIlhU.IlIl_(var1_1, this.connectionState, var11_11, this.packetID);
                    try {
                        try {
                            try {
                            ...
                            if (IlIlhU.IlIl_(var1_1, IlIlrk.PLAY, var11_11, this.packetID) != IlIlAG.DISCONNECT) break block29;
                        }
                        catch (Exception v10) {
                ...
                throw new IlIljj((String)ProtocolPacketEvent.a("w", (int)26522, (long)(5473151697469130632L ^ var7_7)) + this.packetID + (String)ProtocolPacketEvent.a("w", (int)14467, (long)(745285344678647952L ^ var7_7)) + (Object)var1_1.IlIlj() + (String)ProtocolPacketEvent.a("w", (int)24855, (long)(2627262954524885251L ^ var7_7)) + (Object)var3_3.IlIlT() + (String)ProtocolPacketEvent.a("w", (int)21987, (long)(265135041610905075L ^ var7_7)) + this.serverVersion.IlIlz());
            }
            this.packetType = var12_12;
        }
    }

    public ProtocolPacketEvent(int n, IlIloL ilIloL, ServerVersion serverVersion, Object object, IlIlG2 ilIlG2, @UnknownNullability Object object2, Object object3) {
        IlIlrk ilIlrk;
        block11: {
            IlIlG2 ilIlG22;
            block9: {
                block10: {
                    ...
                    try {
                        try {
                            ...
                            if (ilIloL.IlIlY() != IlIlhC.SERVER) break block10;
                        }
                        catch (IlIljj ilIljj) {
                            throw ProtocolPacketEvent.a(ilIljj);
                        }
    ...
    public SocketAddress getAddress() {
        return IlIlZg.IlIlr(this.channel);
    }
    ...
    public IlIlrk getConnectionState() {
        return this.connectionState;
    }

    @Deprecated
    public ClientVersion getClientVersion() {
        return this.user.IlIlh();
    }

    @Deprecated
    public void setClientVersion(ClientVersion clientVersion) {
        long l = c ^ 0x17B1597D025CL;
        IlIlr7.IlIlb().IlIlm().IlIlM((String)((Object)ProtocolPacketEvent.a("w", (int)22538, (long)(0x6847826FD6F5EDD0L ^ l))) + clientVersion.IlIlr());
        this.user.IlIl_(clientVersion);
    }
    ...
    public Object getFullBufferClone() {
        byte[] byArray = ByteBufHelper.IlIlN(this.getByteBuf());
        Object object = UnpooledByteBufAllocationHelper.buffer();
        ByteBufHelper.IlIlN(object, this.getPacketId());
    ...
    public static int IlIlB() {
        int n = ProtocolPacketEvent.IlIlj();
        try {
            if (n == 0) {
                return 66;
            }
    ...
    static {
        block11: {
            block10: {
                ProtocolPacketEvent.c = IlIls.a(1668809225046633515L, -8691100683395275227L, MethodHandles.lookup().lookupClass()).a(156947976994966L);
                ProtocolPacketEvent.f = new HashMap<K, V>(13);
                ProtocolPacketEvent.IlIlw(0);
