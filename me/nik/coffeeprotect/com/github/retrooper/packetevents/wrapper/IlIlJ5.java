...
public class IlIlJ5
extends PacketWrapper<IlIlJ5> {
    private String IlIla;
    private byte[] IlIld;
    private static int IlIlY;
    private static final long b;
    private static final String c;
    private static final long g;
    private static transient /* synthetic */ String ewAbpzxQqW = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";

    public IlIlJ5(PacketReceiveEvent packetReceiveEvent) {
        super(packetReceiveEvent);
    }

    public IlIlJ5(ResourceLocation resourceLocation, byte[] byArray) {
        this(resourceLocation.toString(), byArray);
    }

    public IlIlJ5(String string, byte[] byArray) {
        super(IlIlqy.PLUGIN_MESSAGE);
        this.IlIla = string;
        this.IlIld = byArray;
    }
            ...
            block8: {
                ...
                try {
                    try {
                        ilIlJ5 = this;
                        if (n != 0) break block7;
                        if (ByteBufHelper.IlIlH(ilIlJ5.IlIlS) <= (int)g) break block8;
                    }
                    catch (RuntimeException runtimeException) {
                        throw IlIlJ5.a(runtimeException);
                    }
    ...
    public void IlIlJ() {
        ...
        this.IlIle(this.IlIld);
    }

    public void IlIlt(IlIlJ5 ilIlJ5) {
        this.IlIla = ilIlJ5.IlIla;
        this.IlIld = ilIlJ5.IlIld;
    }
    ...
    public void IlIlF(byte[] byArray) {
        this.IlIld = byArray;
    }

    public static void IlIld(int n) {
        IlIlY = n;
    }
     ...
     */
    static {
        b = IlIls.a(-103352098018344109L, -8598636277114292252L, MethodHandles.lookup().lookupClass()).a(77375556990757L);
