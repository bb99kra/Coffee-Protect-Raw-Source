...
extends PacketWrapper<IlIlJz> {
    ...
    private byte[] IlIlE;
    private static final long b = IlIls.a(-1203038720377133394L, 3966186739327591104L, MethodHandles.lookup().lookupClass()).a(212915985249121L);
    private static final String c;
    private static final long g;
    private static transient /* synthetic */ String hqCpQoqOQE = "4ke1LtZcTsZhhrNjbc5YgpMFiBc3gyeJo7/AqXBycJU=";

    public IlIlJz(PacketSendEvent packetSendEvent) {
        super(packetSendEvent);
    }

    public IlIlJz(ResourceLocation resourceLocation, byte[] byArray) {
        this(resourceLocation.toString(), byArray);
    }

    public IlIlJz(String string, byte[] byArray) {
        super(IlIlWz.PLUGIN_MESSAGE);
        this.IlIlp = string;
        this.IlIlE = byArray;
    }
    ...
    public void IlIle() {
            ...
            block5: {
                ...
                try {
                    try {
                        ...
                        if (ByteBufHelper.IlIlH(ilIlJz.IlIlS) <= (int)g) break block5;
                    }
                    catch (RuntimeException runtimeException) {
                        throw IlIlJz.a(runtimeException);
                    }
        ...
        ilIlJz.IlIlE = this.IlIlq();
    }

    @Override
    public void IlIlJ() {
        this.IlIlM(this.IlIlp);
        this.IlIle(this.IlIlE);
    }

    public void IlIlZ(IlIlJz ilIlJz) {
        this.IlIlp = ilIlJz.IlIlp;
        this.IlIlE = ilIlJz.IlIlE;
    }
    ...
    public void IlIlT(byte[] byArray) {
        this.IlIlE = byArray;
    }
