...
implements IlIlG0 {
    ...
    @Override
    public IlIlG0 copy(@Nullable TypesBuilderData typesBuilderData) {
    ...
    public boolean deepEquals(@Nullable Object object) {
        ...
        block14: {
            ...
            block13: {
                ...
                stringArray = StaticPaintingVariant.IlIlR();
                Object object2 = this;
                if (stringArray != null) {
                    if (object2 == object) {
                        return true;
    ...
    static {
        block14: {
            block13: {
                block12: {
                    StaticPaintingVariant.b = IlIls.a(-3311518023621028285L, -219214675398274824L, MethodHandles.lookup().lookupClass()).a(73112511093046L);
                    StaticPaintingVariant.f = new HashMap<K, V>(13);
                    StaticPaintingVariant.IlIlY(new String[2]);
