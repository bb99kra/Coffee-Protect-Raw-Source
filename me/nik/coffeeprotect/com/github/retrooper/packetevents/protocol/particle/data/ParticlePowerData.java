...
extends IlIlut {
    private float power;
    private static final long a = IlIls.a(-7089488707824633315L, 6899505303547643289L, MethodHandles.lookup().lookupClass()).a(168151036530448L);
    ...
    public static ParticlePowerData read(PacketWrapper<?> var0) {
        ...
        if (v0.IlIlw().IlIlC(ServerVersion.V_1_21_9)) {
            v1 = 1.0f;
        } else {
            v0 = var0;
lbl9:
    ...
    public static void write(PacketWrapper<?> packetWrapper, ParticlePowerData particlePowerData) {
        block3: {
            ...
            block2: {
                ...
                if (!packetWrapper2.IlIlw().IlIlz(ServerVersion.V_1_21_9)) break block3;
                packetWrapper2 = packetWrapper;
            }
            packetWrapper2.IlIlR(particlePowerData.power);
        }
    }
    ...
    public static void encode(ParticlePowerData particlePowerData, ClientVersion clientVersion, NBTCompound nBTCompound) {
        block5: {
            ...
            block4: {
                l = a ^ 0xEA8374D2991L;
                String[] stringArray = IlIlut.IlIlc();
                bl = clientVersion.IlIlw(ClientVersion.V_1_21_9);
