...
class IlIlZs
implements NbtCodec<IlIlrI> {
    private static final long a = IlIls.a(3882199609411324649L, -2518443350845580775L, MethodHandles.lookup().lookupClass()).a(279048465583882L);
     ...
     */
    public IlIlrI IlIlJ(NBT var1_1, PacketWrapper<?> var2_2) {
        block21: {
            block22: {
                block24: {
                    block25: {
                        block23: {
                            var3_3 = IlIlZs.a ^ 44589439144188L;
                            var5_4 = IlIlXv.IlIlk();
                            try {
                        ...
                        v5 = IlIlZs.b("z", (int)11083, (long)(1337647592161791074L ^ var3_3));
                        ...
                        try {
                            ...
                            throw new IlIlXv((String)IlIlZs.a("y", (int)18856, (long)(7359881364588406436L ^ var3_3)));
                        }
                    ...
                    try {
                        ...
                        if (var5_4) {
                            v2 = (char)(v8.length() - 1);
                            v5 = IlIlZs.b("z", (int)1263, (long)(5437920304014058437L ^ var3_3));
                        }
                        ** GOTO lbl56
                    }
                ...
                try {
                    if (v2 != v5) {
                        throw new IlIlXv((String)IlIlZs.a("y", (int)32201, (long)(1119589557779600068L ^ var3_3)) + var6_5);
                    }
                }
...
lbl56:
                    ...
                    var7_6 = v8;
                    var8_8 = Integer.parseInt(var7_6, (int)IlIlZs.b("z", (int)10117, (long)(1996512060957900973L ^ var3_3)));
                    return new IlIlrI(var8_8);
                }
                catch (NumberFormatException var7_7) {
                    throw new IlIlXv(var7_7);
                }
            }
        ...
        try {
            if (v0) {
                return new IlIlrI(((NBTNumber)var1_1).getAsInt());
            }
        }
    ...
    public NBT IlIle(PacketWrapper<?> packetWrapper, IlIlrI ilIlrI) {
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = IlIlZs.a(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        c = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (d[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/com/github/retrooper/packetevents/protocol/util/IlIlZs", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            IlIlZs.d[n2] = IlIlZs.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return d[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/com/github/retrooper/packetevents/protocol/util/IlIlZs" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIlZs.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(IlIlZs.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
