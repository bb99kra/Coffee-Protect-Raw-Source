...
extends NBTNumber {
    ...
    public static void IlIlb(String[] stringArray) {
        IlIla = stringArray;
    }
     ...
     */
    static {
        b = IlIls.a(-5631819824693209964L, -9097466265611345740L, MethodHandles.lookup().lookupClass()).a(93836299555492L);
        long l = b ^ 0x6D2D7FF9EE5DL;
        NBTInt.IlIlb(new String[4]);
