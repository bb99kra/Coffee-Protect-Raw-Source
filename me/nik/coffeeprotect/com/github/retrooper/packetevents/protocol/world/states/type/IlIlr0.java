...
import me.nik.coffeeprotect.com.github.retrooper.packetevents.protocol.world.IlIln1;
import me.nik.coffeeprotect.com.github.retrooper.packetevents.wrapper.IlIls;

class IlIlr0 {
    static final int[] IlIlY;
    ...
    static {
        block29: {
            block28: {
                var11 = IlIls.a(1754202150227652361L, -1764278182512113872L, MethodHandles.lookup().lookupClass()).a(159521122615465L) ^ 117362031642356L;
...
lbl50:
        ...
        IlIlr0.IlIlY = new int[IlIln1.values().length];
        try {
            IlIlr0.IlIlY[IlIln1.AIR.ordinal()] = 1;
        }
        catch (NoSuchFieldError var13_11) {
            // empty catch block
        }
        try {
            IlIlr0.IlIlY[IlIln1.STRUCTURAL_AIR.ordinal()] = 2;
        }
        catch (NoSuchFieldError var13_12) {
            // empty catch block
        }
        try {
            IlIlr0.IlIlY[IlIln1.REPLACEABLE_PLANT.ordinal()] = 3;
        }
        catch (NoSuchFieldError var13_13) {
            // empty catch block
        }
        try {
            IlIlr0.IlIlY[IlIln1.REPLACEABLE_FIREPROOF_PLANT.ordinal()] = 4;
        }
        catch (NoSuchFieldError var13_14) {
            // empty catch block
        }
        try {
            IlIlr0.IlIlY[IlIln1.REPLACEABLE_WATER_PLANT.ordinal()] = 5;
        }
        catch (NoSuchFieldError var13_15) {
            // empty catch block
        }
        try {
            IlIlr0.IlIlY[IlIln1.WATER.ordinal()] = (int)var0_3[4];
        }
        catch (NoSuchFieldError var13_16) {
            // empty catch block
        }
        try {
            IlIlr0.IlIlY[IlIln1.BUBBLE_COLUMN.ordinal()] = (int)var0_3[1];
        }
        catch (NoSuchFieldError var13_17) {
            // empty catch block
        }
        try {
            IlIlr0.IlIlY[IlIln1.LAVA.ordinal()] = (int)var0_3[3];
        }
        catch (NoSuchFieldError var13_18) {
            // empty catch block
        }
        try {
            IlIlr0.IlIlY[IlIln1.TOP_SNOW.ordinal()] = (int)var0_3[0];
        }
        catch (NoSuchFieldError var13_19) {
            // empty catch block
        }
        try {
            IlIlr0.IlIlY[IlIln1.FIRE.ordinal()] = (int)var0_3[2];
        }
