...
extends IlIlut {
    ...
    public ParticleDustData(float f, IlIlQG ilIlQG) {
        this(f, ilIlQG.IlIlY(), ilIlQG.IlIlg(), ilIlQG.IlIlu());
    }

    public ParticleDustData(float f, int n, int n2, int n3) {
        this(f, new IlIlrI(n, n2, n3));
    }

    public ParticleDustData(float f, IlIlrI ilIlrI) {
        this.scale = f;
        this.color = ilIlrI;
    }
        ...
        block4: {
            ...
            block2: {
                block3: {
                    ...
                    if (!packetWrapper2.IlIlw().IlIlz(ServerVersion.V_1_21_2)) break block3;
                    ilIlrI = new IlIlrI(packetWrapper.IlIlW());
                    if (stringArray == null) break block4;
                }
                packetWrapper2 = packetWrapper;
            }
            f = packetWrapper2.IlIlX();
            float f2 = packetWrapper.IlIlX();
            float f3 = packetWrapper.IlIlX();
            ilIlrI = new IlIlrI(f, f2, f3);
        }
        f = packetWrapper.IlIlX();
        ...
        block4: {
            ...
            block2: {
                block3: {
                    ...
                    if (stringArray != null) break block2;
                    if (!packetWrapper2.IlIlw().IlIlz(ServerVersion.V_1_21_2)) break block3;
                    packetWrapper.IlIla(particleDustData.color.asRGB());
                    if (stringArray == null) break block4;
                }
                packetWrapper.IlIlR(particleDustData.getRed());
                packetWrapper.IlIlR(particleDustData.getGreen());
                packetWrapper2 = packetWrapper;
            }
            packetWrapper2.IlIlR(particleDustData.getBlue());
        }
        packetWrapper.IlIlR(particleDustData.scale);
    }

    public static ParticleDustData decode(NBTCompound nBTCompound, ClientVersion clientVersion) {
        long l = a ^ 0x1E2B2F573929L;
        IlIlrI ilIlrI = IlIlrI.IlIlI(nBTCompound.getTagOrThrow((String)((Object)ParticleDustData.a("f", (int)1938, (long)(0x362FBF5A6B8EE14L ^ l)))), clientVersion);
    ...
    public static void encode(ParticleDustData particleDustData, ClientVersion clientVersion, NBTCompound nBTCompound) {
        ...
        nBTCompound.setTag((String)((Object)ParticleDustData.a("f", (int)914, (long)(0x3D2C33BC4BDA78CCL ^ l))), IlIlrI.IlIlG(particleDustData.color, clientVersion));
    ...
    public void setRed(float f) {
        this.color = new IlIlrI(f, this.getGreen(), this.getBlue());
    }
    ...
    public void setGreen(float f) {
        this.color = new IlIlrI(this.getRed(), f, this.getBlue());
    }
    ...
    public void setBlue(float f) {
        this.color = new IlIlrI(this.getRed(), this.getGreen(), f);
    }
    ...
    public IlIlrI getColor() {
        return this.color;
    }

    public void setColor(IlIlrI ilIlrI) {
        this.color = ilIlrI;
    }
    ...
    static {
        block11: {
            block10: {
                ParticleDustData.a = IlIls.a(763597209925032813L, 2817347939895671333L, MethodHandles.lookup().lookupClass()).a(161600085417380L);
