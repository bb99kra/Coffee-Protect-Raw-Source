...
import me.nik.coffeeprotect.com.github.retrooper.packetevents.protocol.particle.data.IlIlAF;
...
implements IlIlAF {
    ...
    public ParticleItemStackData(IlIlCg ilIlCg) {
        this.itemStack = ilIlCg;
    }

    public IlIlCg getItemStack() {
        return this.itemStack;
    }

    public void setItemStack(IlIlCg ilIlCg) {
        this.itemStack = ilIlCg;
    }

    public static ParticleItemStackData read(PacketWrapper<?> packetWrapper) {
        long l = a ^ 0xFC35AE13741L;
        if (packetWrapper.IlIlw().IlIlz(ServerVersion.V_1_13)) {
            return new ParticleItemStackData(IlIln7.IlIlq(packetWrapper));
        }
        return new ParticleItemStackData(IlIlCg.IlIlq().IlIlC((ItemType)ItemTypes.getRegistry().IlIlA(packetWrapper.IlIlB(), packetWrapper.IlIlf())).IlIlt(packetWrapper).IlIlD());
    }

    public static void write(PacketWrapper<?> packetWrapper, ParticleItemStackData particleItemStackData) {
        IlIln7.IlIlx(packetWrapper, particleItemStackData.getItemStack());
    }

    public static ParticleItemStackData decode(NBTCompound nBTCompound, ClientVersion clientVersion) {
        long l = a ^ 0x3284616C3D99L;
        CallSite callSite = clientVersion.IlIlw(ClientVersion.V_1_20_5) ? ParticleItemStackData.a("e", (int)32374, (long)(0x538748567C2000FCL ^ l)) : ParticleItemStackData.a("e", (int)1570, (long)(0x7D5767C93BE478A9L ^ l));
        IlIlCg ilIlCg = IlIlCg.IlIlz(nBTCompound.getTagOrThrow((String)((Object)callSite)), clientVersion);
    ...
    public static void encode(ParticleItemStackData particleItemStackData, ClientVersion clientVersion, NBTCompound nBTCompound) {
        ...
        CallSite callSite = clientVersion.IlIlw(ClientVersion.V_1_20_5) ? ParticleItemStackData.a("e", (int)20136, (long)(0x638B7044C141A5F2L ^ l)) : ParticleItemStackData.a("e", (int)23536, (long)(0xB62FBF977CE30ABL ^ l));
        nBTCompound.setTag((String)((Object)callSite), IlIlCg.IlIli(particleItemStackData.itemStack, clientVersion));
    }
    ...
    public LegacyParticleData toLegacy(ClientVersion clientVersion) {
        return LegacyParticleData.ofTwo(this.itemStack.IlIlJ().IlIlH(clientVersion), this.itemStack.IlIlE());
    }
        ...
        block3: {
            block4: {
                block2: {
                    ...
                    String[] stringArray = IlIlut.IlIlc();
    ...
    static {
        block11: {
            block10: {
                ParticleItemStackData.a = IlIls.a(-281712786797865248L, -2773642733151287000L, MethodHandles.lookup().lookupClass()).a(277138964030038L);
