...
implements NbtCodec<AlphaColor> {
    private static final long a = IlIls.a(-6493228469736637316L, -3521809827968292100L, MethodHandles.lookup().lookupClass()).a(116007550411889L);
     ...
     */
    public AlphaColor IlIlU(NBT var1_1, PacketWrapper<?> var2_2) {
        block21: {
            block22: {
                block24: {
                    block25: {
                        block23: {
                            var3_3 = IlIlry.a ^ 41466743394030L;
                            var5_4 = IlIlXv.IlIlk();
                            try {
                        ...
                        v5 = IlIlry.b("r", (int)18248, (long)(6845914117474932764L ^ var3_3));
                        ...
                        try {
                            ...
                            throw new IlIlXv((String)IlIlry.a("g", (int)7556, (long)(8397553706087971154L ^ var3_3)));
                        }
                    ...
                    try {
                        ...
                        if (var5_4) {
                            v2 = (char)(v8.length() - 1);
                            v5 = IlIlry.b("r", (int)6552, (long)(2349121340298036943L ^ var3_3));
                        }
                        ** GOTO lbl56
                    }
                ...
                try {
                    if (v2 != v5) {
                        throw new IlIlXv((String)IlIlry.a("g", (int)21554, (long)(6043594686603473125L ^ var3_3)) + var6_5);
                    }
                }
...
lbl56:
                    ...
                    var7_6 = v8;
                    var8_8 = Integer.parseUnsignedInt(var7_6, (int)IlIlry.b("r", (int)13352, (long)(6379457273722579838L ^ var3_3)));
    ...
    public NBT IlIlC(PacketWrapper<?> packetWrapper, AlphaColor alphaColor) {
    ...
    static {
        ...
        while (true) {
            ...
            stringArray[n++] = IlIlry.a(byArray3).intern();
            if ((n4 += n3) >= n2) break;
            n3 = string.charAt(n4);
        }
        c = stringArray;
    ...
    private static String a(int n, long l) {
        ...
        if (d[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("me/nik/coffeeprotect/com/github/retrooper/packetevents/protocol/util/IlIlry", exception);
            }
            byte[] byArray = new byte[8];
            byArray[0] = (byte)(l >>> 56);
            for (int i = 1; i < 8; ++i) {
            ...
            IlIlry.d[n2] = IlIlry.a(((Cipher)objectArray[0]).doFinal(byArray2));
        }
        return d[n2];
    }
    ...
    private static CallSite a(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("me/nik/coffeeprotect/com/github/retrooper/packetevents/protocol/util/IlIlry" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(IlIlry.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", null));
        }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(IlIlry.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
