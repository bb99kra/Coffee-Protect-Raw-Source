...
extends IlIlut {
    private int delay;
    private static final long a = IlIls.a(1016906611403049173L, -7758925918642876079L, MethodHandles.lookup().lookupClass()).a(262584135395901L);
    ...
    public static ParticleShriekData read(PacketWrapper<?> packetWrapper) {
        return new ParticleShriekData(packetWrapper.IlIlf());
    }

    public static void write(PacketWrapper<?> packetWrapper, ParticleShriekData particleShriekData) {
        packetWrapper.IlIlJ(particleShriekData.getDelay());
    }
