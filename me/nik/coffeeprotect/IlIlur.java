...
public class IlIlur
extends IlIluV {
    private static final long b = IlIls.a(2642267270536832029L, -5395196143836573459L, MethodHandles.lookup().lookupClass()).a(189415754874378L);
        ...
        block9: {
            ...
            block7: {
                block8: {
                    l = b ^ 0x6170F223DE25L;
                    string = IlIlu7.IlIlq();
                    IlIloL ilIloL = packetReceiveEvent.getPacketType();
                    if (string == null) {
                        if (ilIloL != IlIlnN.CREATIVE_INVENTORY_ACTION) {
                            return null;
                        }
