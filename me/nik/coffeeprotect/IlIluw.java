...
public class IlIluw
extends IlIluV {
    private static final long b = IlIls.a(945157817482135844L, -3394171564546458896L, MethodHandles.lookup().lookupClass()).a(56700329974101L);
    ...
    public IlIlTV IlIlh(PacketReceiveEvent packetReceiveEvent) {
        block4: {
            ...
            block5: {
                ...
                if (ilIlTM.IlIlG() <= e) break block4;
