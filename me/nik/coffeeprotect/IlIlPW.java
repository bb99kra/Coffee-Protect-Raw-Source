...
extends IlIlPw {
    ...
    private static final long a = IlIls.a(-7727497895276768812L, -3528345259117305771L, MethodHandles.lookup().lookupClass()).a(268858867662618L);
            ...
            block12: {
                ...
                block9: {
                    block10: {
                        ...
                        packetWrapper = new IlIlDq(packetSendEvent);
                        l = ((IlIlDq)packetWrapper).IlIlT();
                        if (stringArray != null) break block11;
                    }
                    ilIloL = packetSendEvent.getPacketType();
                }
                if (ilIloL != IlIlWz.KEEP_ALIVE) break block12;
                packetWrapper = new IlIlJK(packetSendEvent);
                l = ((IlIlJK)packetWrapper).IlIlF();
                if (stringArray != null) break block11;
            }
            return;
        }
