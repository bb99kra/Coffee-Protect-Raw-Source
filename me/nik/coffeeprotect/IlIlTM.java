...
public class IlIlTM {
    ...
    public ClientVersion IlIlE() {
        ...
        if (this.IlIlD == ClientVersion.UNKNOWN && (player = Bukkit.getPlayer((UUID)this.IlIlu)) != null) {
            this.IlIlD = IlIlr7.IlIlb().IlIlq().IlIlY(player);
        }
        return this.IlIlD;
    }
    ...
    static {
        block14: {
            block13: {
                block12: {
                    IlIlTM.a = IlIls.a(2817480816040098864L, -6323277062824538867L, MethodHandles.lookup().lookupClass()).a(162872413571850L);
